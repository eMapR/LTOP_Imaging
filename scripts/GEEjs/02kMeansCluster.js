...
var sample10k = ee.FeatureCollection("users/emaprlab/SERVIR/v2/snic_seed_pixels_points_attributed_randomSubset_75k");
Map.addLayer(sample10k)
print(sample10k.first())
//////////////////////////////////////////////////////////
////////////////////SNIC/////////////////////////////
///////////////////////////////////////////////////////
...
//var clusterImage = CambodiaSNIC_v1_QA.cluster(training).clip(aoi);
...
Export.image.toDrive({
        image:clusterSeed, 
        description: 'servir_cambodia_clusterSNICseed_75k_v2_5000', 
        folder:'servir_cambodia_clusterSNICseed_75k_v2_5000', 
        fileNamePrefix: "servir_cambodia_clusterSNICseed_75k_v2_5000", 
        //region:aoi, 
        scale:30, 
        maxPixels: 1e13 
})   
