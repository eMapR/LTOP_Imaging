...
if __name__ == "__main__":
    ...
    input_data = pd.read_csv("/media/peter/vol1/v1/ltop_test_local/abstract_image/SERVIR_abstractSampler_annualSRcollectionTranformed_NBRTCWTCGNDVIB5_sampleTable_v1.csv")
    output_directory_raster = "/media/peter/vol1/v1/ltop_test_local/abstract_image/tifs/"
    output_directory_shp = "/media/peter/vol1/v1/ltop_test_local/abstract_image/shps/"

    
    # Define the output directory for the abstract images and the shapefile
    #input_data = pd.read_csv("D:\\v1\\ltop_test_local\\abstract_image\\SERVIR_abstractSampler_annualSRcollectionTranformed_NBRTCWTCGNDVIB5_sampleTable_v1.csv")
    #output_directory_raster = "D:\\v1\\ltop_test_local\\abstract_image\\"
    #output_directory_shp = "D:\\v1\\ltop_test_local\\abstract_image\\"
